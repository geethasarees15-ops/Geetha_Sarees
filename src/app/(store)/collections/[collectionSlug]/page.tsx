...
export function generateMetadata({ params }: CategoryPageProps) {
  ...
  return {
    ...
    description: `Shop ${collectionName} sarees at Geetha Sarees. Premium silk and cotton sarees with secure online ordering.`,
    alternates: {
      canonical: path,
    },
    openGraph: {
      title: `${collectionName} Sarees | Geetha Sarees`,
      description: `Shop ${collectionName} sarees at Geetha Sarees.`,
      url: path,
    },
  };
}
